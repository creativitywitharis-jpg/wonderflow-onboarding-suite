-- ─────────────────────────────────────────────────────────────────────────
-- WonderFlow OS — Team workspace: real internal announcements (per-tenant).
-- Scoped as a simple posted-message board (channel + body + author + time),
-- not full real-time multi-user chat — no realtime infra exists yet anywhere
-- in this app, so this stays consistent: refresh-based, like every other
-- module. Powers Team → Communication (Phase 7, final).
-- ─────────────────────────────────────────────────────────────────────────
